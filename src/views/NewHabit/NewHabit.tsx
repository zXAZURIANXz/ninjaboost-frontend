...
import { getIconService } from '../../services/searchIcon';
...
export const NewHabit = () => {
    ...
    const options                      		= utils?.days,
          ...
          [title, setTitle]            		= useState<string>('Enter the title of your new habit'),
          [description,setDescription] 		= useState<string>('Add details like time, frequency, or motivation'),
    ...
    const createHabit = () => {
      ...
      const newHabit: Habit = { 
          ...
          icon        : iconSelect
			 ...
			 messageApi.open({
        type: 'success',
        content: 'Habit created! One step closer to your goal.',
      });
